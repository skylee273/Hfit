...
public class ContactDBKcal {
    private ContactDBKcal(){};

    public static final String TBL_CONTACT = "KCALDATA";
    public static final String COL_DATE = "KCALDATE" ;
    ...
    public static final String SQL_INSERT = "INSERT OR REPLACE INTO " + TBL_CONTACT + " " +
            "(" + COL_DATE + ", " + COL_WEEK + ", " + COL_HOUR + ", " + COL_KCAL + ") VALUES " ;
