...
public class ContactDBCHeart {

    private ContactDBCHeart(){};

    public static final String TBL_CONTACT = "HEART";
    public static final String COL_DATE = "HEARTDATE" ;
    ...
    public static final String SQL_INSERT = "INSERT OR REPLACE INTO " + TBL_CONTACT + " " +
            "(" + COL_DATE + ", " + COL_WEEK + ", " + COL_HOUR + ", " + COL_BPM + ") VALUES " ;
