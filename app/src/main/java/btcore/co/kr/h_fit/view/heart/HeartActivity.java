package btcore.co.kr.h_fit.view.heart;
...
import btcore.co.kr.h_fit.view.heart.presenter.HeartPresenter;
import btcore.co.kr.h_fit.view.main.MainActivity;
import btcore.co.kr.h_fit.R;
import btcore.co.kr.h_fit.view.heart.fragment.HeartGraphMonthFragment;
import btcore.co.kr.h_fit.view.heart.fragment.HeartGraphTodayFragment;
import btcore.co.kr.h_fit.view.heart.fragment.HeartGraphWeekFragment;
...
public class HeartActivity extends AppCompatActivity implements View.OnClickListener, HeartData.View {
    ...
    private ViewPager mHeartViewpager;
    ...
    private void initView() {
        ...
        Toolbar toolbar = findViewById(R.id.heart_toolbar);
        setSupportActionBar(toolbar);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setHomeAsUpIndicator(R.drawable.icon_menu_back);
        actionBar.setTitle("심박수");
        actionBar.setDisplayHomeAsUpEnabled(true);

        mTextHeart = findViewById(R.id.text_hearts);
        ...
        mHeartViewpager = findViewById(R.id.viewpager_heart);
        mHeartViewpager.setAdapter(new pagerAdapter(getSupportFragmentManager()));
        mHeartViewpager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
            ...
            public void onPageSelected(int position) {
                switch (position) {
                    case 0:
                        mButtonToday.setTextColor(Color.parseColor("#F08080"));
                    ...
                    case 1:
                        ...
                        mButtonWeek.setTextColor(Color.parseColor("#F08080"));
                        mButtonMonth.setTextColor(Color.parseColor("#FFFFFF"));
                        break;
                    case 2:
                        mButtonToday.setTextColor(Color.parseColor("#FFFFFF"));
                        mButtonWeek.setTextColor(Color.parseColor("#FFFFFF"));
                        mButtonMonth.setTextColor(Color.parseColor("#F08080"));
                        break;
                }
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_today:
                mHeartViewpager.setCurrentItem(0);
                break;
            case R.id.btn_week:
                mHeartViewpager.setCurrentItem(1);
                break;
            case R.id.btn_month:
                mHeartViewpager.setCurrentItem(2);
                break;
        }
    }
    ...
    private class pagerAdapter extends FragmentStatePagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new HeartGraphTodayFragment();
                case 1:
                    return new HeartGraphWeekFragment();
                case 2:
                    return new HeartGraphMonthFragment();
                default:
                    return null;
            }
        }
